...
| [10-roadmap-to-release.md](10-roadmap-to-release.md) | 规划 | Web-first：二维码、设备生命周期、管理/部署体验与国际化；移动发行后移 |
| [11-web-qr-pairing.md](11-web-qr-pairing.md) | 实录 | Web 二维码配对：离线 QR、public URL、fragment 预填与真实浏览器验证 |
...
| [decisions/ADR-0009-web-qr-pairing.md](decisions/ADR-0009-web-qr-pairing.md) | ADR | 二维码只携单次码 fragment，离线生成并需用户确认 |
